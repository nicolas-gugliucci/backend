...
describe("Testing products routes", () => {
    ...
    it("[GET] - Retrieves all products created", async function(){
    ...
    it("[GET] - Retrieves a product by ID", async function(){
    ...
    it("[PUT] - Updates a product by ID", async function(){
    ...
    it("[DELETE] - Deletes a product by ID", async function(){
